...
print(profs.shape, med_good.shape)
...
keepers = (xcorr >= 0.98) & (e < 0.05) & (mosaic_cat['MAG_AUTO'] > 16) & (mosaic_cat['MAG_AUTO'] < 23) & (np.abs(xcens) < 0.5) & (np.abs(ycens) < 0.5)# | ((xcorr >= 0.999) & (e < 0.05) & (mosaic_cat['MAG_AUTO'] < 22) & (mosaic_cat['MAG_AUTO'] > 17))
